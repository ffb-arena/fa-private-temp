    ...
    update(mul, maxX, maxY) { // maxX and maxY are room limits
        ...
        if (!this.keyboard) {
            ...
            if (this.mouse.mouseX || this.mouse.mouseY) {
                ...
                this.movement.direction = F.normalize(this.movement.direction);
            }
        ...
        if (this.movement.accOffset.x) {
            ...
            this.movement.accOffset.x -= C.wasdSmooth * mul * F.whichOne(oldAccelX);
        ...
        if (this.movement.accOffset.y) {
            ...
            this.movement.accOffset.y -= C.wasdSmooth * mul * F.whichOne(oldAccelY);
        ...
        this.movement.direction.x += this.movement.accOffset.x * C.acc.flower * C.friction * mul;
        this.movement.direction.y += this.movement.accOffset.y * C.acc.flower * C.friction * mul;
        this.movement.direction.x = F.clamp(
            this.movement.direction.x,
            -C.acc.flower * C.friction * mul,
            C.acc.flower * C.friction * mul
        );
        this.movement.direction.y = F.clamp(
