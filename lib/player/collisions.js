...
function handleCollision(p1, p2, mul) {
    ...
    const p1angle1 = Math.atan2(p1.petalCentre.x - intersect1.x, p1.petalCentre.y - intersect1.y);
    const p1angle2 = Math.atan2(p1.petalCentre.x - intersect2.x, p1.petalCentre.y - intersect2.y);
    const p2angle1 = Math.atan2(p2.petalCentre.x - intersect1.x, p2.petalCentre.y - intersect1.y);
    const p2angle2 = Math.atan2(p2.petalCentre.x - intersect2.x, p2.petalCentre.y - intersect2.y);
    console.log(p1angle1, p1angle2, p2angle1, p2angle2);
    // p1.pubInfo.petals.forEach(petal => {
    //     if (petal.degree > p1angle1 && petal.degree < p1angle2) {
    //         const data = [
    //             "a",
    //             { x: petal.x, y: petal.y },
    //             petal.radius
    ...
    //     if (petal.degree > p2angle1 && petal.degree < p2angle2) {
    //         const data = [
    //             "a",
    //             { x: petal.x, y: petal.y },
    //             petal.radius
