...
class Room {
    ...
    update(mul) {
        ...
        sortedPlayers.forEach(player => {
            ...
            last = [player.petalCentre.x + player.petalDist + C.collisionPadding, player];
        });
        ...
        possibleCollisions.forEach(array => {
            ...
            array.forEach((player, i) => {
                for (let n = i + 1; n < length; n++) {
                    ...
                    if (player2.petalCentre.y - player2.petalDist < player.petalCentre.y + player.petalDist + C.collisionPadding) {
        ...
        this.players.forEach((player, i) => {
            ...
            if (this.debug) {
                player.ws.send(JSON.stringify(["z", debugInfo]));
            }
        });
    }
